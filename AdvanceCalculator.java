...
public class AdvanceCalculator extends JFrame implements ActionListener {
	JTextField tfield;
	...
	JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, zero, clr, pow2, pow3,
			fac, plus, min, div, log, rec, mul, equal, dot, 
	...
	AdvanceCalculator() {
		...
		buttonpanel.setLayout(new GridLayout(7, 3, 4, 4));
		boolean t = true;
